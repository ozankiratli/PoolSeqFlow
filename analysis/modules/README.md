...
A fresh installation holds the modules this release ships and nothing else. Everything else is installed separately from the pipeline, into this release's own installation, so a module installed for one release is never picked up by another.
